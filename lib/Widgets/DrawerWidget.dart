          ...
          DrawerHeader(
            padding: EdgeInsets.zero,
              child: UserAccountsDrawerHeader(
                ...
                accountName: Text("Ridwan", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                accountEmail: Text("ridwan.cseju@gmail.com", style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold),),
